...
h = pygame.image.load("main-clock.png")
h = pygame.transform.scale(h, clock_main.get_size())
clock_main.blit(h, (0, 0))
clock_second = pygame.image.load("left-hand.png")
cl = clock_main.get_rect().center

clock_minute = pygame.image.load("right-hand.png")
...
while True:
    ...
    some_minute, pos_minute = rot_center(clock_minute, 150 - minutes_time * 6, *cl)
